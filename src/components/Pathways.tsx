...
const pathways = [
  {
    ...
    desc: 'Enter the Uplift AI Career Accelerator. Map your position on the 6-Tier Ascent, build proof-of-work, and access referrals to internships at top AI firms.',
  ...
  },
  {
    ...
    desc: 'Join the Career Accelerator to advance through the 6-Tier Ascent. Get role-based clarity, tailored pathways, and referrals for senior and founder-level placements.',
  ...
  },
  {
    ...
    desc: 'Mentor in the Career Accelerator. Lead circles and clinics, supervise projects, and shape the next generation of AI talent through the 6-Tier Ascent.',
  ...
  },
  {
    ...
    desc: 'Partner with the Career Accelerator. Access validated talent trained through the 6-Tier Ascent for roles across the Integration Era.',
