...
const steps = [
  ...
  },
  {
    ...
    time: 'Same day',
    desc: 'Pick from 3 packages starting at $300. Each maps to specific tiers and career outcomes. We recommend the best fit based on your assessment.',
  ...
  },
  {
    ...
    time: '2+ weeks per tier',
    desc: 'Attend micro-classes, work with your mentor, and build proof-of-work every tier. Your GitHub portfolio and personal website grow with each project you ship.',
